...
class GameMap:
	...
	def create_room(self, room):
		#make a walkable rectangle room
		...
		for i in range(number_of_items):
			...
			if not any([entity for entity in entities if entity.x == x and entity.y == y]):
				...
				if item_choice == 'healing_potion':
					...
					item_component = Item(use_function=cast_confuse, targeting=True, targeting_message = Message('L-click to cast confuse, R-click to cancel.', libtcod.light_cyan))
	...
	def next_floor(self, player, message_log, constants):
		...
		message_log.add_message(Message('You descend a winding staircase.', libtcod.light_violet))
